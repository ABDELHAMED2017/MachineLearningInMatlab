...
function [y, LL_time, neurons_all] = NeuralNetworkEarlyStopProb(adj_matrix, input, targets, num_input_nodes, num_hidden_nodes, num_output_nodes, ...
    ...
    y = binaryThresholdVector(g(:,total_num_nodes),0.5); %assuming output is only 1D
end
